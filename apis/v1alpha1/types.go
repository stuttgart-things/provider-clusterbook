...
// +kubebuilder:resource:scope=Namespaced,categories={crossplane,provider,clusterbook}
// A ProviderConfig configures a Clusterbook provider.
...
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:printcolumn:name="URL",type="string",JSONPath=".spec.url",priority=1
// +kubebuilder:resource:scope=Cluster,categories={crossplane,provider,clusterbook}
// A ClusterProviderConfig configures a Clusterbook provider.
